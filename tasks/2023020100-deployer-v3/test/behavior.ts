...
import { DeployerV3Deployment } from '../input'

export default function itDeploysDeployerV3Correctly(): void {
  ...
  it('registers the Deployer lib under the expected namespace', async function () {
    ...
    const { namespace, version } = this.task.input() as DeployerV3Deployment
