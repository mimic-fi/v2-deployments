...
const BalancerFeeCollectorTask = new Task('2023032102-balancer-fee-collector-l2')
...
export default {
  ...
  L2HopBridger: BalancerFeeCollectorTask,
  PermissionsManager: BalancerFeeCollectorTask,
  BalancerVault: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
  owner: TESTING_EOA,
}

export type BalancerFeeCollectorL2Updates = {
  namespace: string
  version: string
  from: string
  relayer: string
