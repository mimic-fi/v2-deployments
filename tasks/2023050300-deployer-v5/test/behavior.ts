...
import { DeployerV5Deployment } from '../input'

export default function itDeploysDeployerV5Correctly(): void {
  ...
  it('registers the Deployer lib under the expected namespace', async function () {
    ...
    const { namespace, version } = this.task.input() as DeployerV5Deployment
