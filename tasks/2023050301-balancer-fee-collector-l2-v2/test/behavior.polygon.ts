...
export default function itDeploysBalancerFeeCollectorV2Correctly(): void {
  ...
  describe('claimer', () => {
    ...
    it('sets the proper protocol fee withdrawer', async () => {
      expect(await claimer.protocolFeeWithdrawer()).to.be.equal('0xEF44D6786b2b4d544b7850Fe67CE6381626Bf2D6')
    })
    ...
    it('sets the expected limits', async () => {
      ...
      expect(await claimer.gasPriceLimit()).to.be.equal(200e9)
    })
  ...
  describe('bpt swapper', () => {
    ...
    it('sets the expected limits', async () => {
      expect(await bptSwapper.gasPriceLimit()).to.be.equal(200e9)
    })
  ...
  describe('paraswap swapper', () => {
    ...
    it('sets the expected gas limits', async () => {
      ...
      expect(await paraswapSwapper.gasPriceLimit()).to.be.equal(200e9)
    })
  ...
  describe('bridger', () => {
    ...
    it('sets the expected gas limits', async () => {
      ...
      expect(await bridger.gasPriceLimit()).to.be.equal(200e9)
    })
