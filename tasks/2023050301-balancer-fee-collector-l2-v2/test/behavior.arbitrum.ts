...
export default function itDeploysBalancerFeeCollectorV2Correctly(): void {
  ...
  describe('claimer', () => {
    ...
    it('sets the proper protocol fee withdrawer', async () => {
      expect(await claimer.protocolFeeWithdrawer()).to.be.equal('0x0a7C92Fc003908327BB2726D62D080d9276ab24d')
    })
    ...
    it('sets the expected limits', async () => {
      ...
      expect(await claimer.gasPriceLimit()).to.be.equal(10e9)
    })
  ...
  describe('bpt swapper', () => {
    ...
    it('sets the expected limits', async () => {
      expect(await bptSwapper.gasPriceLimit()).to.be.equal(10e9)
    })
  ...
  describe('1inch swapper', () => {
    ...
    it('sets the expected gas limits', async () => {
      ...
      expect(await oneInchSwapper.gasPriceLimit()).to.be.equal(10e9)
    })
  ...
  describe('paraswap swapper', () => {
    ...
    it('sets the expected gas limits', async () => {
      ...
      expect(await paraswapSwapper.gasPriceLimit()).to.be.equal(10e9)
    })
  ...
  describe('bridger', () => {
    ...
    it('sets the expected gas limits', async () => {
      ...
      expect(await bridger.gasPriceLimit()).to.be.equal(10e9)
    })
