...
const HOP_DAI_AMM = '0x28529fec439cfF6d7D1D5917e956dEE62Cd3BE5c'
const HOP_USDC_AMM = '0x76b22b8C1079A44F1211D867D68b1eda76a635A7'
const HOP_USDT_AMM = '0x8741Ba6225A6BF91f9D73531A98A89807857a2B3'
...
const CHAINLINK_ORACLE_ETH_USD = '0xF9680D99D6C9589e2a93a78A04A279e509205945'
const CHAINLINK_ORACLE_USDC_USD = '0xfE4A8cc5b5B2366C1B58Bea3858e81843581b2F7'
const CHAINLINK_ORACLE_USDT_USD = '0x0A6513e40db6EB1b165753AD52E80663aeA50545'
const CHAINLINK_ORACLE_MATIC_USD = '0xAB594600376Ec9fD91F8e885dADF0CE036862dE0'
...
export function itDeploysMimicFeeCollectorCorrectly(): void {
  ...
  describe('smart vault', () => {
    ...
    it('sets the expected price feeds', async function () {
      ...
      expect(await smartVault.getPriceFeed(WMATIC, USD)).to.be.equal(CHAINLINK_ORACLE_MATIC_USD)
    })
  })
  ...
  describe('bridger', () => {
    ...
    it('allows the requested chains', async function () {
      ...
      expect(await bridger.isChainAllowed(137)).to.be.false
    })
